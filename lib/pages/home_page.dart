        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                CustomCard(
                  image: Image.asset('assets/icons/crop recommendation.webp'),
                  title: 'Crop Recommendation',
                  nextPage: const CropRecommendationPage1(),
                ),
                CustomCard(
                  image: Image.asset('assets/icons/irrigation.jpg'),
            ...
            Row(
              children: [
                CustomCard(
                  image: Image.asset('assets/icons/fertilizer.webp'),
                  title: 'Fertilizer Recommendation',
                  nextPage: const FertilizerRecommendationPage(),
                ),
                CustomCard(
                  image: Image.asset('assets/icons/pesticide.webp'),
